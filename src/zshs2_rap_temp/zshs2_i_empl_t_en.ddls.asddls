//@AbapCatalog.sqlViewName: 'ZSHS2IEMPLTEN'
//@AbapCatalog.compiler.compareFilter: true
//@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'English Employee Names'
define view entity ZSHS2_I_EMPL_T_EN
  ...
  association to parent ZSHS2_I_EMPLOYEES as _Employees on $projection.EmployeeID = _Employees.EmployeeID
{
  ...
  key e_id         as EmployeeID,
      e_first_name as EmployeeFirstName_En,
      e_mid_name   as EmployeeMiddleName_En,
      e_last_name  as EmployeeLastName_En,
      _Employees
}
where
  langu = 'E'
